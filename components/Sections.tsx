...
export function ServiceCards() {
  const visibleServices = servicePages.filter((service) => service.slug !== "storm-damage-restoration");
  const waterServices = visibleServices.filter((service) => !service.slug.includes("mold"));
  const moldServices = visibleServices.filter((service) => service.slug.includes("mold"));
